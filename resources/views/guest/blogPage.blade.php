...
@section('content')
    ...
    <x-detail-post.header :imageProfile="$post->user->imageProfile" :username="$post->user->name" :email="$post->user->email" :date="$post->created_at" :title="$post->title" :iduser="$post->user_id" ></x-detail-post.header>
