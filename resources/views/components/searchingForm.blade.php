<h1 class="flex items-center justify-center w-full text-5xl text-gray-900 font-bold text-center my-6">Searching The {{ $slot }}</h1>
<form action="{{ $link }}" method="GET" class="flex items-center w-full ">
    @csrf
