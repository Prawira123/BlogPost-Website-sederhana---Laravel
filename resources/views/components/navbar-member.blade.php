<header class="fixed inset-x-0 top-0 z-50 bg-gray-800">
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="{{ route('membership.authorsPage') }}" class="text-sm/6 font-semibold text-white">Authors</a>
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end lg:space-x-2">
       ...
       <form action="{{ route('logout') }}" method="POST">
          ...
          <button type="submit" class="text-sm/6 font-semibold text-white bg-white/5 rounded-full px-3.5 py-1.5 hover:bg-white/10 p-10">Log Out <span aria-hidden="true">&rarr;</span></button>
       </form>
     </div>
