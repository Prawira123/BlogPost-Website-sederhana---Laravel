...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js'])    <title>Document</title>
</head>
<body>
    <!-- 
...
<main class="mt-10 pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased text-white">
...
<aside aria-label="Related articles" class="py-3 lg:py-24 bg-gray-50 dark:bg-gray-800">
  <div class="px-4 mx-auto max-w-screen-xl">
      <h2 class="mb-8 text-4xl font-bold text-gray-900 dark:text-white">Related articles</h2>
